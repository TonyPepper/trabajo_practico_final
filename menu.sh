...
select programa in "I.E. de longitud de palabras" "I.E. de uso de palabras" "Nombres propios" "I.E. de longitud de oraciones" "Contador de líneas en blanco" "Reemplazo de cadenas" "SALIR" 
do
[ -e "$programa" ] && echo "Elegir opcion valida!" && continue
[ "$REPLY" == 7 ] && echo "Hasta luego" && break
...
[ "$REPLY" == 6 ] && /bin/bash substringReplace.sh texto.txt
